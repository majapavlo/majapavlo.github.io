            ...
            <ul class={styles.NewsList}>
              <li>
                ...
                <div><strong><em>Supervised Program for Alignment Research (SPAR):</em></strong>&nbsp;
                  Joined a <a href="https://sparai.org/" target="_blank">SPAR</a> project on scalable oversight, where I'll be working with a team towards <a href="https://airtable.com/appypGt9DhCljq3Gh/shrpaJMUhvElTxcI8?detail=&VbNhN=allRecords">achieving Human-AI complementarity</a>
                </div>
              </li>
              <li>
