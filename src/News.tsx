      ...
      <Container>
        ...
        <div class="news">
          ...
          <ul class={styles.NewsList}>
            ...
            <li>
              <div class="date">Jun 2023</div>
              <div>Accepted to the <a href="https://www.ellis.eng.cam.ac.uk/summer-school/" target="_blank"> Cambridge Summer School on Probabilistic Machine Learning</a> (Ellis Unit). </div>
            </li>
            <li>
